...
Bezier::Bezier(int nbVertex):Courbes(nbVertex)
{
...
arma::mat Bezier::getMat(){
    return besierMat;
}

arma::mat Bezier::CalculerCourbe(double t){
...
arma::mat Bezier::Deriver(double t)
{
...
arma::mat Bezier::DeriverSeconde(double t)
{
